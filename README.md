...
[![Build Status](https://travis-ci.org/alper1976/python-tdd-exercises.svg?branch=master)](https://travis-ci.org/alper1976/python-tdd-exercises/builds)
[![Coverage Status](https://coveralls.io/repos/alper1976/python-tdd-exercises/badge.png?branch=master)](https://coveralls.io/r/alper1976/python-tdd-exercises?branch=master)

After you fork, edit this `README.md` and rename "alper1976" to your GitHub username
...
- Increase the test coverage to 100% by making [all lines](https://coveralls.io/r/alper1976/python-tdd-exercises?branch=master) green.
